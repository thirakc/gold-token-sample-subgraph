...
export class SampleToken extends ethereum.SmartContract {
  static bind(address: Address): SampleToken {
    return new SampleToken("SampleToken", address);
  }
  ...
  getReleaseTime(): BigInt {
    let result = super.call("getReleaseTime", "getReleaseTime():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getReleaseTime(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getReleaseTime",
